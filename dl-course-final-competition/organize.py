...
# test_txt = test_txt.drop(columns=[0])
test_txt['label'] = 0
test_txt=test_txt.reindex(columns=columns_titles)
print(test_txt)
...
train_txt_key['title'] = train_txt_key[train_txt_key.columns[4:]].apply(
